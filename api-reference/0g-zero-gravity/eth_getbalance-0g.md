...
This method returns the 0G balance of an address in wei at a given block. It is the primary way to read native balances on 0G.
...
* **Wallet Balances**: Display an account's native 0G balance
