...
--data-raw '{
    "jsonrpc": "2.0",
    "method": "eth_getCode",
    "params": ["0x0fA8781a83E46826621b3BC094Ea2A0212e71B23", "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const code = await provider.getCode('0x0fA8781a83E46826621b3BC094Ea2A0212e71B23');
```
{% endcode %}
{% endtab %}
...
const code = await client.getCode({ address: '0x0fA8781a83E46826621b3BC094Ea2A0212e71B23' });
```
{% endcode %}
{% endtab %}
{% endtabs %}
