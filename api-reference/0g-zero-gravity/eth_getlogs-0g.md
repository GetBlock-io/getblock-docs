...
--data-raw '{
    "jsonrpc": "2.0",
    "method": "eth_getLogs",
    "params": [{ "fromBlock": "0xb71b00", "toBlock": "0xb71c00", "address": "0x0fA8781a83E46826621b3BC094Ea2A0212e71B23", "topics": ["0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef"] }],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const logs = await provider.getLogs({ address: '0x0fA8781a83E46826621b3BC094Ea2A0212e71B23', topics: ['0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef'], fromBlock: 12000000 });
```
{% endcode %}
{% endtab %}
...
const logs = await client.getLogs({ address: '0x0fA8781a83E46826621b3BC094Ea2A0212e71B23', fromBlock: 12000000n });
```
{% endcode %}
{% endtab %}
{% endtabs %}
