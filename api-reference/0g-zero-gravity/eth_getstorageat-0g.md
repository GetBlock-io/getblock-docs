...
--data-raw '{
    ...
    "params": ["0x0fA8781a83E46826621b3BC094Ea2A0212e71B23", "0x0", "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const value = await provider.getStorage('0x0fA8781a83E46826621b3BC094Ea2A0212e71B23', 0);
```
{% endcode %}
{% endtab %}
...
const value = await client.getStorageAt({ address: '0x0fA8781a83E46826621b3BC094Ea2A0212e71B23', slot: '0x0' });
```
{% endcode %}
{% endtab %}
{% endtabs %}
