...
# eth\_getTransactionReceipt - 0g

This method returns the receipt of a mined transaction, including its status, gas used, and emitted logs. On 0G the receipt also carries L1 fee fields. It returns null until the transaction is mined.
