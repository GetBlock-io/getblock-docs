...
# eth\_blockNumber - Abstract

This method returns the number of the most recent block, as a hex-encoded integer. It is the primary way to read the current chain tip on Abstract.
