...
# eth\_chainId - Abstract

This method returns the chain ID used for replay-protected transaction signing per EIP-155. On Abstract it returns 0xab5 (2741), which wallets and libraries use to build valid signatures.
...
| result    | string | Hex-encoded chain ID (0xab5 for Abstract) |

## Use Cases

* **EIP-155 Signing**: Build replay-protected transaction signatures for Abstract
