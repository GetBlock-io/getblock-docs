...
# eth\_estimateGas - Abstract

This method returns an estimate of the gas required to execute a transaction, without submitting it. On Abstract the estimate covers L2 execution gas; the L1 data fee is separate.
...
--data-raw '{
    ...
    "params": [{ "from": "0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045", "to": "0x3439153EB7Af838Ad19d56E1571FBD09333C2809", "value": "0xde0b6b3a7640000" }],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const gas = await provider.estimateGas({ from: '0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045', to: '0x3439153EB7Af838Ad19d56E1571FBD09333C2809', value: ethers.parseEther('1') });
```
{% endcode %}
{% endtab %}
...
const gas = await client.estimateGas({ account: '0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045', to: '0x3439153EB7Af838Ad19d56E1571FBD09333C2809', value: parseEther('1') });
```
{% endcode %}
{% endtab %}
{% endtabs %}
