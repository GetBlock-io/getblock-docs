...
# eth\_getBalance - Abstract

This method returns the ETH balance of an address in wei at a given block. It is the primary way to read native balances on Abstract.
...
* **Wallet Balances**: Display an account's native ETH balance
