...
--data-raw '{
    "jsonrpc": "2.0",
    "method": "eth_getCode",
    "params": ["0x3439153EB7Af838Ad19d56E1571FBD09333C2809", "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const code = await provider.getCode('0x3439153EB7Af838Ad19d56E1571FBD09333C2809');
```
{% endcode %}
{% endtab %}
...
const code = await client.getCode({ address: '0x3439153EB7Af838Ad19d56E1571FBD09333C2809' });
```
{% endcode %}
{% endtab %}
{% endtabs %}
