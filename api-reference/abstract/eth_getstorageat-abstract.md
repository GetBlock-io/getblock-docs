...
--data-raw '{
    ...
    "params": ["0x3439153EB7Af838Ad19d56E1571FBD09333C2809", "0x0", "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const value = await provider.getStorage('0x3439153EB7Af838Ad19d56E1571FBD09333C2809', 0);
```
{% endcode %}
{% endtab %}
...
const value = await client.getStorageAt({ address: '0x3439153EB7Af838Ad19d56E1571FBD09333C2809', slot: '0x0' });
```
{% endcode %}
{% endtab %}
{% endtabs %}
