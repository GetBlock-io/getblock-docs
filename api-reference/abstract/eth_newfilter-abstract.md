...
--data-raw '{
    ...
    "params": [{ "fromBlock": "0xb71b00", "toBlock": "latest", "address": "0x3439153EB7Af838Ad19d56E1571FBD09333C2809", "topics": ["0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef"] }],
    "id": "getblock.io"
}'
```
{% endcode %}
...
provider.on({ address: '0x3439153EB7Af838Ad19d56E1571FBD09333C2809', topics: ['0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef'] }, (log) => console.log(log));
```
{% endcode %}
{% endtab %}
...
const filter = await client.createEventFilter({ address: '0x3439153EB7Af838Ad19d56E1571FBD09333C2809' });
```
{% endcode %}
{% endtab %}
{% endtabs %}
