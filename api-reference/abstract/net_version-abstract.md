...
# net\_version - Abstract

This method returns the network ID as a decimal string. On Abstract the network ID matches the chain ID (2741) and is used to confirm which network an endpoint is connected to.
...
| result    | string | Network ID as a decimal string (2741 for Abstract) |

## Use Cases

* **Network Confirmation**: Verify a wallet or dApp is pointed at Abstract and not another chain
