...
--data-raw '{
    ...
    "id": "getblock.io",
    "method": "abci_query",
    "params": {"path": "/cosmos.bank.v1beta1.Query/AllBalances", "data": "0a2c616b617368313778706676616b6d32616d67393632796c73366638347a336b656c6c3863356c617a77386a38", "height": "0", "prove": false}
}'
```
{% endcode %}
{% endtab %}
...
const response = await axios.post('https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/', { jsonrpc: '2.0', id: 'getblock.io', method: 'abci_query', params: {"path": "/cosmos.bank.v1beta1.Query/AllBalances", "data": "0a2c616b617368313778706676616b6d32616d67393632796c73366638347a336b656c6c3863356c617a77386a38", "height": "0", "prove": false} }, { headers: { 'Content-Type': 'application/json' } });
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let res = client.post("https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/").json(&json!({"jsonrpc":"2.0","id":"getblock.io","method":"abci_query","params":{"path": "/cosmos.bank.v1beta1.Query/AllBalances", "data": "0a2c616b617368313778706676616b6d32616d67393632796c73366638347a336b656c6c3863356c617a77386a38", "height": "0", "prove": false}})).send().await?.json::<Value>().await?;
    println!("{}", res["result"]);
    Ok(())
}
```
...
```json
{
    ...
    "result": {
        "response": {
            ...
            "index": "0",
            "key": null,
            "value": "Cg8KBHVha3QSBzIzMDA3NTYSAhAB",
            "proofOps": null,
            "height": "28742443",
            "codespace": ""
        }
