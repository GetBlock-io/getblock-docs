---
description: >-
  Example code for the lookupAccountAppLocalStates REST method. Complete guide
  on how to use lookupAccountAppLocalStates REST in GetBlock Web3 documentation.
---

# lookupAccountAppLocalStates - Algorand
...
curl "${ALGO_INDEXER}v2/accounts/REPLACE_ACCOUNT-ID/apps-local-state"
```
{% endcode %}
