---
description: >-
  Example code for the lookupAccountAssets REST method. Complete guide on how to
  use lookupAccountAssets REST in GetBlock Web3 documentation.
---

# lookupAccountAssets - Algorand
...
curl "${ALGO_INDEXER}v2/accounts/REPLACE_ACCOUNT-ID/assets"
```
{% endcode %}
