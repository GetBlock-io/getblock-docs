---
description: >-
  Example code for the lookupAccountCreatedAssets REST method. Complete guide on
  how to use lookupAccountCreatedAssets REST in GetBlock Web3 documentation.
---

# lookupAccountCreatedAssets - Algorand
...
curl "${ALGO_INDEXER}v2/accounts/REPLACE_ACCOUNT-ID/created-assets"
```
{% endcode %}
