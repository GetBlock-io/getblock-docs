# eth\_getBlockByNumber - Arbitrum Nova

This method returns block data for a hex-encoded block number or a tag such as latest, safe, finalized, earliest, or pending. It is the most common block-lookup method for indexers and explorers on GIWA Sepolia.
