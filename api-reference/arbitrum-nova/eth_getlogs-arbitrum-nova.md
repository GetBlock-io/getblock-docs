...
--data-raw '{
    "jsonrpc": "2.0",
    "method": "eth_getLogs",
    "params": [{ "fromBlock": "0x14b8a10", "toBlock": "0x14b8b10", "address": "0x4200000000000000000000000000000000000006", "topics": ["0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef"] }],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const logs = await provider.getLogs({ address: '0x4200000000000000000000000000000000000006', topics: ['0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef'], fromBlock: 21727760 });
```
{% endcode %}
{% endtab %}
...
const logs = await client.getLogs({ address: '0x4200000000000000000000000000000000000006', fromBlock: 21727760n });
```
{% endcode %}
{% endtab %}
{% endtabs %}
