# eth\_getTransactionReceipt - Arbitrum Nova

This method returns the receipt of a mined transaction, including its status, gas used, and emitted logs. On GIWA Sepolia the receipt also carries OP Stack L1 fee fields. It returns null until the transaction is mined.
...
| l1Fee             | string | OP Stack L1 data-availability fee for this transaction (hex, wei) |
...
* **L2 Cost Accounting**: Sum L2 execution and OP Stack L1 fees for true cost
