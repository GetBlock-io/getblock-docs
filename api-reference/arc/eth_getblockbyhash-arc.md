...
* Verifying block identity for trust-minimized applications
* Reorg detection — note that Arc's Malachite finality makes deep reorgs essentially impossible
