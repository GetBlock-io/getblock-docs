...
const result = await provider.send('eth_getTransactionCount', ["0x4cef52a8f9d4b0c8b8d5f1a2b3c4d5e6f7a8b9c0", "latest"]);
console.log(result);
```
{% endtab %}
...
const result = await client.request({ method: 'eth_getTransactionCount', params: ["0x4cef52a8f9d4b0c8b8d5f1a2b3c4d5e6f7a8b9c0", "latest"] });
console.log(result);
```
{% endtab %}
{% endtabs %}
