...
# eth\_maxPriorityFeePerGas - ARC

This method returns the suggested priority fee per gas (the "tip" portion of EIP-1559 transactions), in USDC base units. Use this together with the block's base fee to construct a competitive EIP-1559 transaction.
...
| ------ | ------ | ----------------------------------------------------------- |
| result | string | Suggested max priority fee per gas in USDC base units (hex) |

## Use Cases

* Setting `maxPriorityFeePerGas` on EIP-1559 transactions
* Wallet UX showing recommended priority tips
* Server-side fee oracles that price urgency in USD terms
