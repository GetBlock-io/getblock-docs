...
# eth\_newBlockFilter - ARC

This method creates a filter that emits the hash of every new block produced on Arc. Poll it with `eth_getFilterChanges` to receive new block hashes since the previous poll.
