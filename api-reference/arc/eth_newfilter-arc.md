...
const result = await provider.send('eth_newFilter', [{"fromBlock": "latest", "address": "0x4cef52a8f9d4b0c8b8d5f1a2b3c4d5e6f7a8b9c0", "topics": ["0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef"]}]);
console.log(result);
```
{% endcode %}
{% endtab %}
...
const result = await client.request({ method: 'eth_newFilter', params: [{"fromBlock": "latest", "address": "0x4cef52a8f9d4b0c8b8d5f1a2b3c4d5e6f7a8b9c0", "topics": ["0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef"]}] });
console.log(result);
```
{% endcode %}
{% endtab %}
