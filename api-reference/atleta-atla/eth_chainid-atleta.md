...
This method returns the chain ID used for replay-protected transaction signing per EIP-155. On Atleta it returns 0x988 (2440), which wallets and libraries use to build valid signatures.
...
| result    | string | Hex-encoded chain ID (0x988 for Atleta) |

## Use Cases

* **EIP-155 Signing**: Build replay-protected transaction signatures for Atleta
