...
# eth\_getBalance - Atleta

This method returns the ATLA balance of an address in wei at a given block. It is the primary way to read native balances on Atleta.
...
* **Wallet Balances**: Display an account's native ATLA balance
