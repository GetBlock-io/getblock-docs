...
--data-raw '{
    "jsonrpc": "2.0",
    "method": "eth_getCode",
    "params": ["0x8b5C8aE3E4CE2A5cD9dE9c4A0f6b3E1d2C7a4F09", "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const code = await provider.getCode('0x8b5C8aE3E4CE2A5cD9dE9c4A0f6b3E1d2C7a4F09');
```
{% endcode %}
{% endtab %}
...
const code = await client.getCode({ address: '0x8b5C8aE3E4CE2A5cD9dE9c4A0f6b3E1d2C7a4F09' });
```
{% endcode %}
{% endtab %}
{% endtabs %}
