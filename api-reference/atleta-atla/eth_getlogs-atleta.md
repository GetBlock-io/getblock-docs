...
--data-raw '{
    "jsonrpc": "2.0",
    "method": "eth_getLogs",
    "params": [{ "fromBlock": "0xb71b00", "toBlock": "0xb71c00", "address": "0x8b5C8aE3E4CE2A5cD9dE9c4A0f6b3E1d2C7a4F09", "topics": ["0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef"] }],
    "id": "getblock.io"
}'
```
{% endcode %}
...
```json
{
    ...
    "result": [
        {
            "address": "0x8b5C8aE3E4CE2A5cD9dE9c4A0f6b3E1d2C7a4F09",
...
const logs = await provider.getLogs({ address: '0x8b5C8aE3E4CE2A5cD9dE9c4A0f6b3E1d2C7a4F09', topics: ['0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef'], fromBlock: 12000000 });
```
{% endcode %}
{% endtab %}
...
const logs = await client.getLogs({ address: '0x8b5C8aE3E4CE2A5cD9dE9c4A0f6b3E1d2C7a4F09', fromBlock: 12000000n });
```
{% endcode %}
{% endtab %}
{% endtabs %}
