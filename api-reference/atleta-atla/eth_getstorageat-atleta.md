...
--data-raw '{
    ...
    "params": ["0x8b5C8aE3E4CE2A5cD9dE9c4A0f6b3E1d2C7a4F09", "0x0", "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const value = await provider.getStorage('0x8b5C8aE3E4CE2A5cD9dE9c4A0f6b3E1d2C7a4F09', 0);
```
{% endcode %}
{% endtab %}
...
const value = await client.getStorageAt({ address: '0x8b5C8aE3E4CE2A5cD9dE9c4A0f6b3E1d2C7a4F09', slot: '0x0' });
```
{% endcode %}
{% endtab %}
{% endtabs %}
