...
--data-raw '{
    ...
    "params": [{ "fromBlock": "0xb71b00", "toBlock": "latest", "address": "0x8b5C8aE3E4CE2A5cD9dE9c4A0f6b3E1d2C7a4F09", "topics": ["0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef"] }],
    "id": "getblock.io"
}'
```
{% endcode %}
...
provider.on({ address: '0x8b5C8aE3E4CE2A5cD9dE9c4A0f6b3E1d2C7a4F09', topics: ['0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef'] }, (log) => console.log(log));
```
{% endcode %}
{% endtab %}
...
const filter = await client.createEventFilter({ address: '0x8b5C8aE3E4CE2A5cD9dE9c4A0f6b3E1d2C7a4F09' });
```
{% endcode %}
{% endtab %}
{% endtabs %}
