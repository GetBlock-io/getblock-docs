...
This method returns the network ID as a decimal string. On Atleta the network ID matches the chain ID (2440) and is used to confirm which network an endpoint is connected to.
...
| result    | string | Network ID as a decimal string (2440 for Atleta) |

## Use Cases

* **Network Confirmation**: Verify a wallet or dApp is pointed at Atleta and not another chain
