...
# childstate\_getStorage - Avail

Returns the value at a key within a child trie (used by pallets that isolate storage, such as contracts), at a block.
...
| --------- | ------ | -------- | ------------------------------------- |
| childKey  | string | Yes      | Hex child storage key (child trie id) |
...
| ------ | -------------- | ------------------------------------------------ |
| result | string \| null | SCALE-encoded child-trie value, or null if empty |

## Use Cases

* **Contract Storage**: Read isolated child-trie storage
* **Pallet Internals**: Inspect pallets that use child tries
* **Indexing**: Snapshot child-trie state
