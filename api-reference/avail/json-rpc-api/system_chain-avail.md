...
Returns the name of the chain the node is connected to (for example, Avail). Used to confirm the node is serving the expected network.
...
* **Network Guard**: Confirm the node serves Avail, not another Substrate chain
