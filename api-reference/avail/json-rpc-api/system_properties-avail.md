...
| ------------- | ------- | ------------------------------------------- |
| ss58Format    | integer | SS58 address prefix (42 for Avail)          |
| tokenDecimals | array   | Decimals of the native token (18 for AVAIL) |
| tokenSymbol   | array   | Native token symbol (AVAIL)                 |

## Use Cases

* **Balance Formatting**: Read tokenDecimals to convert Planck to AVAIL
