...
# chain\_subscribeAllHeads - Avail

Streams every imported block header, including headers from non-canonical forks. WebSocket only. Broader than chain\_subscribeNewHeads, which follows only the best chain.
