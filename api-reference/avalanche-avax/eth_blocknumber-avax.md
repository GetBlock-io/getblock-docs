...
# eth\_blockNumber -AVAX

Returns the number of the most recent C-Chain block. Avalanche's sub-second finality means new blocks land roughly every 2 seconds — this is the standard way to poll for the chain tip.
