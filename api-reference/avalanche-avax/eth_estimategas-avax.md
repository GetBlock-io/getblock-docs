...
# eth\_estimateGas - AVAX

Estimates the gas required to execute a C-Chain transaction without committing it. Use it to determine an appropriate `gas` value before broadcasting.
