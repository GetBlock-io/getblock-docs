...
Returns the current gas price suggested by the C-Chain node, in wei. For more granular options on Avalanche, see the Avalanche-specific `eth_suggestPriceOptions` method.
