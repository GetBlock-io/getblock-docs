...
# eth\_maxPriorityFeePerGas - AVAX

Returns the suggested priority fee per gas (the "tip" portion of EIP-1559 transactions). Use this with the block's base fee to construct a competitive EIP-1559 transaction.
