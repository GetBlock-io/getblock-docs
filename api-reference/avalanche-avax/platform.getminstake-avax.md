---
description: >-
  Example code for the platform.getMinStake JSON-RPC method. Complete guide on
  how to use platform.getMinStake JSON-RPC in GetBlock Web3 documentation.
---
...
| ------------------------ | ------ | --------------------------------------------------------------------------------------- |
| result.minValidatorStake | string | Minimum validator stake in nAVAX (decimal string; 2,000 AVAX = 2,000,000,000,000 nAVAX) |
| result.minDelegatorStake | string | Minimum delegator stake in nAVAX (25 AVAX = 25,000,000,000 nAVAX)                       |
