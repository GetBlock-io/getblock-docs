...
# web3\_clientVersion - AVAX

Returns the version string of the client software running the C-Chain. Typically an AvalancheGo / coreth build.
...
* Capability detection — feature support varies by AvalancheGo version
