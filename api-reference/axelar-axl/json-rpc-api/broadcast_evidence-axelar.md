---
description: >-
  Example code for the broadcast_evidence JSON-RPC method. Complete guide on how
  to use broadcast_evidence JSON-RPC in GetBlock Web3 documentation.
---

# broadcast\_evidence - Axelar
