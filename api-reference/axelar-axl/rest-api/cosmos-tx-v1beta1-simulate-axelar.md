---
description: >-
  Example code for the cosmos/tx/v1beta1/simulate REST method. Complete guide on
  how to use cosmos/tx/v1beta1/simulate REST method in GetBlock Web3
  documentation.
---

# /cosmos/tx/v1beta1/simulate - Axelar
