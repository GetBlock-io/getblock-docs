---
description: >-
  Explore block execution details using debug_traceBlock in the JSON-RPC API
...
Below is a sample JSON response returned by debug\_traceBlock upon a successful call:
