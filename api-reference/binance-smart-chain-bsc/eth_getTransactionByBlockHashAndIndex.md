...
The eth\_getTransactionByBlockHashAndIndex JSON-RPC API method supports the following network types:
...
Below is a sample JSON response returned by eth\_getTransactionByBlockHashAndIndex upon a successful call:
