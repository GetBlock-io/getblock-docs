...
The eth\_getTransactionReceipt JSON-RPC API method supports the following network types:
...
Below is a sample JSON response returned by eth\_getTransactionReceipt upon a successful call:
