...
{% code overflow="wrap" %}
```bash
curl --location --request GET 'https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/api/v2/rawblock/000000000000000000046b9302e08c16ea186950f42a5498320ddd1bd7ab3428'
```
{% endcode %}
{% endtab %}
...
const response = await fetch(
    'https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/api/v2/rawblock/000000000000000000046b9302e08c16ea186950f42a5498320ddd1bd7ab3428'
);
...
response = requests.get('https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/api/v2/rawblock/000000000000000000046b9302e08c16ea186950f42a5498320ddd1bd7ab3428')
