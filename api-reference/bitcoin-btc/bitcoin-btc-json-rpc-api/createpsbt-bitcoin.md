...
* **PSBT Workflows**: Create a PSBT for multi-party signing
* **Hardware Wallets**: Build a PSBT for device signing
* **Custody Systems**: Prepare PSBTs for offline signers
* **Coordination**: Start a collaborative transaction
