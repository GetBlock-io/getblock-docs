...
* **Height Tracking**: Read the current chain height
* **Polling**: Detect new blocks by watching the count
* **Confirmation Math**: Compute confirmations from height
* **Dashboards**: Display the block count
