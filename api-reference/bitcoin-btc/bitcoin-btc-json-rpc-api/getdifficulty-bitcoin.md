...
| result    | number | The current mining difficulty           |

## Use Cases

* **Mining Analytics**: Read the current difficulty
* **Hashrate Estimation**: Combine with block time to estimate hashrate
* **Dashboards**: Display difficulty over time
* **Alerting**: Watch for large difficulty changes
