...
| mempool\_sequence | boolean | No       | Return a JSON object with mempool sequence                            |
...
| result    | array  | Array of transaction IDs (or an object when verbose) |

## Use Cases

* **Mempool Views**: List pending transaction IDs
* **Fee Markets**: Sample pending transactions
* **Transaction Tracking**: Detect whether a txid is pending
* **Indexing**: Ingest the pending set
