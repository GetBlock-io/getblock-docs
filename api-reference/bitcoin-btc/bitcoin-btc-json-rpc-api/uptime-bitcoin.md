...
| result    | number | Node uptime in seconds                  |

## Use Cases

* **Health Checks**: Read how long a node has been up
* **Monitoring**: Detect recent restarts
* **SLA Reporting**: Report node availability
* **Operations**: Correlate uptime with incidents
