...
| ------ | -------- | ----------------------------------------------------- |
| result | QUANTITY | Chain ID in hex — `0x3b1` (945) for Bittensor mainnet |

## Use Cases

* Mandatory before signing EVM transactions (EIP-155 replay protection)
* Detecting accidental connection to wrong network in MetaMask
