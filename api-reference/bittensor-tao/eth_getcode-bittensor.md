...
Returns the bytecode at a contract address on Subtensor EVM. Returns `0x` for EOAs (externally-owned accounts) and addresses with no deployed code.
...
--data-raw '{
    ...
    "method": "eth_getCode",
    "params": [
        "0x4a5d8E91234567890abcdef1234567890ABCDEF12",
        "latest"
    ],
    "id": "getblock.io"
}'
...
* Verifying contract deployment matches expected bytecode
...
const result = await provider.send('eth_getCode', ["0x4a5d8E91234567890abcdef1234567890ABCDEF12", "latest"]);
console.log(result);
...
const result = await client.request({
    method: 'eth_getCode',
    params: ["0x4a5d8E91234567890abcdef1234567890ABCDEF12", "latest"]
});
console.log(result);
```
{% endtab %}
