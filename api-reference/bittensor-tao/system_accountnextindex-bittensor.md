...
| ------ | ------- | -------------------------------------- |
| result | integer | Next transaction nonce for the address |

## Use Cases

* Constructing the next extrinsic before signing and submitting
* Detecting account activity (counting transactions sent)
* Replacing a pending extrinsic with a higher-tip version (same nonce)
...
// Typed wrapper: api.rpc.system.accountNextIndex(...)
const result = await api.rpc.system.accountNextIndex("5GrwvaEF5zXb26Fz9rcQpDWS57CtERHpNehXCPcNoHGKutQY");
