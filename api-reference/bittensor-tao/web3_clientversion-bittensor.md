...
```json
{
    "jsonrpc": "2.0",
    "id": "getblock.io",
    "result": "Subtensor/v1.0.0-frontier/x86_64-linux-gnu"
}
```
...
| ------ | ------ | ---------------------------- |
| result | string | EVM client identifier string |

## Use Cases

* Detecting that you're connected to the EVM interface (not the Substrate interface)
* Compatibility checks against specific Frontier versions
