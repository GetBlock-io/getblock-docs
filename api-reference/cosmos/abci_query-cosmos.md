...
curl --location --request GET 'https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/abci_query?path="/cosmos.bank.v1beta1.Query/Balance"&data="0a2d636f736d6f73317436726c676638306a6438"&prove=false'
```
{% endtab %}
