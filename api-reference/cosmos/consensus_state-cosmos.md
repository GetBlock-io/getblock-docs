...
curl --location --request GET 'https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/consensus_state'
```
{% endtab %}
...
const httpClient = new HttpClient('https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/consensus_params');
...
response = requests.post('https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/consensus_params', json={
    'jsonrpc': '2.0',
    'id': 'getblock.io',
    'method': 'consensus_state',
    'params': []
