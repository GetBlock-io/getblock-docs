...
curl --location --request POST 'https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/header' \
...
curl --location --request GET 'https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/header?height=23456789'
```
{% endtab %}
...
const config = {
    method: 'post',
    url: 'https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/header',
    headers: {
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let response = client
        .post("https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/header")
        .header("Content-Type", "application/json")
        .json(&payload)
        .send()
        .await?;
...
const httpClient = new HttpClient('https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/header');
...
response = requests.post('https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/header', json={
    'jsonrpc': '2.0',
    'id': 'getblock.io',
    'method': 'header',
