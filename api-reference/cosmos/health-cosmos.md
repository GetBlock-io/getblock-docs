...
curl --location --request GET 'https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/health'
```
{% endtab %}
...
| ------ | ------ | -------------------------------------------------------------------- |
| result | object | Empty object — the presence of a non-error response indicates health |
...
const result = await httpClient.execute({"jsonrpc": "2.0", "id": "getblock.io", "method": "health", "params": []});
console.log(result);
```
{% endtab %}
