...
--data-raw '{
    "jsonrpc": "2.0",
    "method": "eth_call",
    "params": [{ "to": "0x5C7F8A570d578ED84E63fdFA7b1eE72dEae1AE23", "data": "0x70a08231000000000000000000000000d8da6bf26964af9d7eed9e03e53415d37aa96045" }, "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const result = await provider.call({ to: '0x5C7F8A570d578ED84E63fdFA7b1eE72dEae1AE23', data: '0x70a08231000000000000000000000000d8da6bf26964af9d7eed9e03e53415d37aa96045' });
```
{% endcode %}
{% endtab %}
...
const balance = await client.readContract({ address: '0x5C7F8A570d578ED84E63fdFA7b1eE72dEae1AE23', abi: erc20Abi, functionName: 'balanceOf', args: ['0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045'] });
```
{% endcode %}
{% endtab %}
{% endtabs %}
