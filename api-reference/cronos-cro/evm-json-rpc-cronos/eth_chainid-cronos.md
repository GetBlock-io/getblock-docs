...
This method returns the chain ID used for replay-protected transaction signing per EIP-155. On Cronos it returns 0x19 (25), which wallets and libraries use to build valid signatures.
...
| result    | string | Hex-encoded chain ID (0x19 for Cronos)  |

## Use Cases

* **EIP-155 Signing**: Build replay-protected transaction signatures for Cronos
