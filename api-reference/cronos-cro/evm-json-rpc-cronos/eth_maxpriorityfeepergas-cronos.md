...
This method returns a suggested max priority fee per gas (the miner/sequencer tip) in wei for EIP-1559 transactions. It is used to build type-2 transactions that confirm promptly on Cronos.
