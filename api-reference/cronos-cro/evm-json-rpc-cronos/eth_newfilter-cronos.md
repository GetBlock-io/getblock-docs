# eth\_newFilter - Cronos

This method creates a log filter matching address and topic criteria and returns a filter ID. New matching logs are then retrieved with eth\_getFilterChanges.
...
--data-raw '{
    ...
    "params": [{ "fromBlock": "0x1900000", "toBlock": "latest", "address": "0x5C7F8A570d578ED84E63fdFA7b1eE72dEae1AE23", "topics": ["0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef"] }],
    "id": "getblock.io"
}'
```
{% endcode %}
...
provider.on({ address: '0x5C7F8A570d578ED84E63fdFA7b1eE72dEae1AE23', topics: ['0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef'] }, (log) => console.log(log));
```
{% endcode %}
{% endtab %}
...
const filter = await client.createEventFilter({ address: '0x5C7F8A570d578ED84E63fdFA7b1eE72dEae1AE23' });
```
{% endcode %}
{% endtab %}
{% endtabs %}
