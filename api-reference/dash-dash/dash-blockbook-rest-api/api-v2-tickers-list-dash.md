---
description: >-
  Example code for the api/v2/tickers-list  REST method. Complete guide on how
  to use the api/v2/tickers-list  REST method in the GetBlock Web3
  documentation.
---

# api/v2/tickers-list - Dash
