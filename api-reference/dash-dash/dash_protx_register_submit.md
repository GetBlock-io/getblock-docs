---
description: >-
  Example code for the protx_register_submit  {disallowed} json-rpc method.
  Сomplete guide on how to use protx_register_submit  {disallowed} json-rpc in
  GetBlock.io Web3 documentation.
---

# protx\_register\_submit {disallowed} - Dash
