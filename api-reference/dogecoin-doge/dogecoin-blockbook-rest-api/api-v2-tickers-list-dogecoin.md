...
{% code overflow="wrap" %}
```bash
curl --location --request GET 'https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/api/v2/tickers-list/?timestamp=1789703885'
```
{% endcode %}
{% endtab %}
...
const response = await fetch(
    'https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/api/v2/tickers-list/?timestamp=1789703885'
);
...
response = requests.get('https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/api/v2/tickers-list/?timestamp=1789703885')
...
The list is alphabetical and truncated above. At the time of writing the endpoint returns 62 currencies for Dogecoin, mixing fiat codes with crypto denominations such as `btc`, `bch`, and `bnb`.
