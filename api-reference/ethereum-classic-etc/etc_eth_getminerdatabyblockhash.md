---
description: >-
  Example code for the eth_getMinerDataByBlockHash json-rpc method. Сomplete
  guide on how to use eth_getMinerDataByBlockHash json-rpc in GetBlock.io Web3
  documentation.
---

# eth\_getMinerDataByBlockHash - Ethereum Classic
