---
description: >-
  Example code for the debug_getBadBlocks JSON-RPC method. Complete guide to
  using debug_getBadBlocks JSON-RPC in GetBlock Web3 documentation.
---

# debug\_getBadBlocks - Ethereum Classic
