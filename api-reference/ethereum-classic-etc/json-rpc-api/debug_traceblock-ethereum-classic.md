---
description: >-
  Example code for the debug_traceBlock JSON-RPC method. Complete guide to using
  debug_traceBlock JSON-RPC in GetBlock Web3 documentation.
---

# debug\_traceBlock - Ethereum Classic
