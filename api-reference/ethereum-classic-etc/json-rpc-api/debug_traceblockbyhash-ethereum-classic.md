---
description: >-
  Example code for the debug_traceBlockByHash JSON-RPC method. Complete guide to
  using debug_traceBlockByHash JSON-RPC in GetBlock Web3 documentation.
---

# debug\_traceBlockByHash - Ethereum Classic
