---
description: >-
  Example code for the debug_traceCall JSON-RPC method. Complete guide to using
  debug_traceCall JSON-RPC in GetBlock Web3 documentation.
---

# debug\_traceCall - Ethereum Classic
...
--data-raw '{
    ...
    "params": [{ "from": "0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045", "to": "0x82A618305706B14e7bcf2592D4B9324A366b6dAd", "data": "0x70a08231000000000000000000000000d8da6bf26964af9d7eed9e03e53415d37aa96045" }, "latest", { "tracer": "callTracer" }],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const trace = await provider.send('debug_traceCall', [{ from: '0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045', to: '0x82A618305706B14e7bcf2592D4B9324A366b6dAd', data: '0x70a08231000000000000000000000000d8da6bf26964af9d7eed9e03e53415d37aa96045' }, 'latest', { tracer: 'callTracer' }]);
```
{% endcode %}
{% endtab %}
...
const trace = await client.request({ method: 'debug_traceCall', params: [{ from: '0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045', to: '0x82A618305706B14e7bcf2592D4B9324A366b6dAd', data: '0x70a08231000000000000000000000000d8da6bf26964af9d7eed9e03e53415d37aa96045' }, 'latest', { tracer: 'callTracer' }] });
```
{% endcode %}
{% endtab %}
{% endtabs %}
