---
description: >-
  Example code for the eth_accounts JSON-RPC method. Complete guide to using
  eth_accounts JSON-RPC in GetBlock Web3 documentation.
---

# eth\_accounts - Ethereum Classic
