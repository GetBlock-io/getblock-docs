...
description: >-
  ...
  eth_blockNumber JSON-RPC in GetBlock Web3 documentation.
---

# eth\_blockNumber - Ethereum Classic

This method returns the number of the most recent block, as a hex-encoded integer. It is the primary way to read the current chain tip on Ethereum Classic.
...
| result    | string | Hex-encoded number of the latest block  |
...
* **Log Range Bounds**: Set toBlock for an eth\_getLogs query to the current tip
...
| ---------- | ---------------- | ------------------------------------------------- |
| -32603     | Internal error   | The node failed to return the latest block number |
