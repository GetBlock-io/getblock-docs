---
description: >-
  Example code for the eth_call JSON-RPC method. Complete guide to using
  eth_call JSON-RPC in GetBlock Web3 documentation.
---

# eth\_call - Ethereum Classic
...
--data-raw '{
    "jsonrpc": "2.0",
    "method": "eth_call",
    "params": [{ "to": "0x82A618305706B14e7bcf2592D4B9324A366b6dAd", "data": "0x70a08231000000000000000000000000d8da6bf26964af9d7eed9e03e53415d37aa96045" }, "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
* **L1 Fee Estimation**: Call the GasPriceOracle predeploy to preview L1 data fees
...
const result = await provider.call({ to: '0x82A618305706B14e7bcf2592D4B9324A366b6dAd', data: '0x70a08231000000000000000000000000d8da6bf26964af9d7eed9e03e53415d37aa96045' });
```
{% endcode %}
{% endtab %}
...
const balance = await client.readContract({ address: '0x82A618305706B14e7bcf2592D4B9324A366b6dAd', abi: erc20Abi, functionName: 'balanceOf', args: ['0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045'] });
```
{% endcode %}
{% endtab %}
{% endtabs %}
