...
description: >-
  ...
  using eth_createAccessList JSON-RPC in GetBlock Web3 documentation.
---

# eth\_createAccessList - Ethereum Classic
...
--data-raw '{
    ...
    "params": [{ "from": "0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045", "to": "0x82A618305706B14e7bcf2592D4B9324A366b6dAd", "data": "0x70a08231000000000000000000000000d8da6bf26964af9d7eed9e03e53415d37aa96045" }, "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const al = await provider.send('eth_createAccessList', [{ from: '0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045', to: '0x82A618305706B14e7bcf2592D4B9324A366b6dAd', data: '0x70a08231000000000000000000000000d8da6bf26964af9d7eed9e03e53415d37aa96045' }, 'latest']);
```
{% endcode %}
{% endtab %}
...
const al = await client.request({ method: 'eth_createAccessList', params: [{ from: '0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045', to: '0x82A618305706B14e7bcf2592D4B9324A366b6dAd', data: '0x70a08231000000000000000000000000d8da6bf26964af9d7eed9e03e53415d37aa96045' }, 'latest'] });
```
{% endcode %}
{% endtab %}
{% endtabs %}
