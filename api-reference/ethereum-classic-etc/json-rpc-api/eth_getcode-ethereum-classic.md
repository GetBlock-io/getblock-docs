---
description: >-
  Example code for the eth_getCode JSON-RPC method. Complete guide to using
  eth_getCode JSON-RPC in GetBlock Web3 documentation.
---

# eth\_getCode - Ethereum Classic
...
--data-raw '{
    "jsonrpc": "2.0",
    "method": "eth_getCode",
    "params": ["0x82A618305706B14e7bcf2592D4B9324A366b6dAd", "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const code = await provider.getCode('0x82A618305706B14e7bcf2592D4B9324A366b6dAd');
```
{% endcode %}
{% endtab %}
...
const code = await client.getCode({ address: '0x82A618305706B14e7bcf2592D4B9324A366b6dAd' });
```
{% endcode %}
{% endtab %}
{% endtabs %}
