...
description: >-
  ...
  using eth_getFilterLogs JSON-RPC in GetBlock Web3 documentation.
---

# eth\_getFilterLogs - Ethereum Classic
...
const logs = await provider.getLogs({ address: '0x82A618305706B14e7bcf2592D4B9324A366b6dAd', topics: ['0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef'] });
```
{% endcode %}
{% endtab %}
