---
description: >-
  Example code for the eth_getLogs JSON-RPC method. Complete guide to using
...
--data-raw '{
    "jsonrpc": "2.0",
    "method": "eth_getLogs",
    "params": [{ "fromBlock": "0x1450000", "toBlock": "0x1450100", "address": "0x82A618305706B14e7bcf2592D4B9324A366b6dAd", "topics": ["0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef"] }],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const logs = await provider.getLogs({ address: '0x82A618305706B14e7bcf2592D4B9324A366b6dAd', topics: ['0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef'], fromBlock: 21299200 });
```
{% endcode %}
{% endtab %}
...
const logs = await client.getLogs({ address: '0x82A618305706B14e7bcf2592D4B9324A366b6dAd', fromBlock: 21299200n });
```
{% endcode %}
{% endtab %}
{% endtabs %}
