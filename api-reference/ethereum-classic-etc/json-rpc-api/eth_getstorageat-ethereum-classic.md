...
description: >-
  ...
  eth_getStorageAt JSON-RPC in GetBlock Web3 documentation.
---

# eth\_getStorageAt - Ethereum Classic
...
--data-raw '{
    ...
    "params": ["0x82A618305706B14e7bcf2592D4B9324A366b6dAd", "0x0", "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const value = await provider.getStorage('0x82A618305706B14e7bcf2592D4B9324A366b6dAd', 0);
```
{% endcode %}
{% endtab %}
...
const value = await client.getStorageAt({ address: '0x82A618305706B14e7bcf2592D4B9324A366b6dAd', slot: '0x0' });
```
{% endcode %}
{% endtab %}
{% endtabs %}
