...
* **Node Role**: Detect whether an endpoint is a mining node
* **Monitoring**: Confirm a miner is producing blocks
* **Diagnostics**: Report node mining state

## Error Handling

| Error Code                | Message        | Description                                       |
| ------------------------- | -------------- | ------------------------------------------------- |
| -32603 / Internal error   | Internal error | The node failed to report mining state            |
