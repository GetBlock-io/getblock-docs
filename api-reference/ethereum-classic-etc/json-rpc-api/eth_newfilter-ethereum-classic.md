...
description: >-
  ...
  eth_newFilter JSON-RPC in GetBlock Web3 documentation.
---
...
--data-raw '{
    ...
    "params": [{ "fromBlock": "0x1450000", "toBlock": "latest", "address": "0x82A618305706B14e7bcf2592D4B9324A366b6dAd", "topics": ["0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef"] }],
    "id": "getblock.io"
}'
```
{% endcode %}
...
provider.on({ address: '0x82A618305706B14e7bcf2592D4B9324A366b6dAd', topics: ['0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef'] }, (log) => console.log(log));
```
{% endcode %}
{% endtab %}
...
const filter = await client.createEventFilter({ address: '0x82A618305706B14e7bcf2592D4B9324A366b6dAd' });
```
{% endcode %}
{% endtab %}
{% endtabs %}
