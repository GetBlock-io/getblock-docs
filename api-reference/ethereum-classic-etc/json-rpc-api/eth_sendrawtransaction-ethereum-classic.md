...
description: >-
  ...
  using eth_sendRawTransaction JSON-RPC in GetBlock Web3 documentation.
---

# eth\_sendRawTransaction - Ethereum Classic
...
* **Value Transfers**: Broadcast a signed native ETC transfer
