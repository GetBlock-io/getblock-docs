...
| result    | string | Network ID as a decimal string (61 for Ethereum Classic) |

## Use Cases

* **Network Confirmation**: Verify a wallet or dApp is pointed at Ethereum Classic and not another chain
