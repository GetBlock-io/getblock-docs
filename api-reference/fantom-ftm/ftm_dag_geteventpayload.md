---
description: >-
  Example code for the dag_getEventPayload json-rpc method. Сomplete guide on
  how to use dag_getEventPayload json-rpc in GetBlock.io Web3 documentation.
---

# dag\_getEventPayload - Fantom
...
Boolean value, returns the full transaction objects if true and only the hashes of the transactions if false.
...
"params": ["0x00033bbf00000719167a3b2c445bd3e53e9c35d16cf52ac24852317b9605d07e", false],
"id": "getblock.io"}'
```
