...
# eth\_chainId - Filecoin

This method returns the chain ID of the Filecoin network, used to sign replay-protected transactions under EIP-155. Filecoin Mainnet returns 0x13a (314).
...
| result    | string | Hex-encoded chain ID (0x13a = 314 for Filecoin Mainnet) |

## Use Cases

* **Replay Protection**: Include the chain ID when signing EIP-155 transactions
* **Network Detection**: Confirm a wallet is connected to Filecoin mainnet
