...
# web3\_clientVersion - Filecoin

This method returns the version string of the Filecoin client software the node is running. It identifies the node implementation and release.
