---
description: >-
  Example code for the Filecoin.StateNetworkVersion JSON RPC method. Complete
  guide on how to use Filecoin.StateNetworkVersion JSON RPC in GetBlock Web3
  documentation.
---

# Filecoin.StateNetworkVersion - Filecoin
