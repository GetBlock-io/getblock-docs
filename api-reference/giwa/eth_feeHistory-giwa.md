...
# eth\_feeHistory - GIWA

This method returns a window of historical base fees, gas-used ratios, and requested priority-fee percentiles. It is the basis for building adaptive EIP-1559 fee strategies on GIWA.
