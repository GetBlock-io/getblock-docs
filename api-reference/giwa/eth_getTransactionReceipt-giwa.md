...
# eth\_getTransactionReceipt - GIWA

This method returns the receipt of a mined transaction, including its status, gas used, and emitted logs. On GIWA the receipt also carries OP Stack L1 fee fields. It returns null until the transaction is mined.
