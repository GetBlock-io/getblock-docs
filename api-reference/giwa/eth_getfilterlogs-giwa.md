...
| --------- | ---- | -------- | ----------- |
| filterId | string | Yes | Filter ID returned by eth_newFilter |
...
const logs = await provider.getLogs({ address: '0x4200000000000000000000000000000000000006', topics: ['0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef'] });
```
