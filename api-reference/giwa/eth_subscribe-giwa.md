...
{% hint style="info" %}
This method works only over a WebSocket connection. Use the `wss://` form of the endpoint (`wss://shared.ap-southeast-1.getblock.io/<ACCESS-TOKEN>/`) rather than HTTPS.
{% endhint %}
...
const provider = new ethers.WebSocketProvider('wss://shared.ap-southeast-1.getblock.io/<ACCESS-TOKEN>/');
...
const client = createPublicClient({ transport: webSocket('wss://shared.ap-southeast-1.getblock.io/<ACCESS-TOKEN>/') });
