...
# web3\_clientVersion - GIWA

This method returns the version string of the execution client serving the GIWA endpoint. It is used to identify the node software and version behind a GetBlock endpoint for compatibility checks and debugging.
