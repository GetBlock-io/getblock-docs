...
--data-raw '{
    "jsonrpc": "2.0",
    "method": "eth_call",
    "params": [{ "to": "0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a", "data": "0x70a08231000000000000000000000000d8da6bf26964af9d7eed9e03e53415d37aa96045" }, "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const result = await provider.call({ to: '0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a', data: '0x70a08231000000000000000000000000d8da6bf26964af9d7eed9e03e53415d37aa96045' });
```
{% endcode %}
{% endtab %}
...
const balance = await client.readContract({ address: '0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a', abi: erc20Abi, functionName: 'balanceOf', args: ['0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045'] });
```
{% endcode %}
{% endtab %}
{% endtabs %}
