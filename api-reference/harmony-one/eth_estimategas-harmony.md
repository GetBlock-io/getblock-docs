# eth\_estimateGas - Harmony

This method returns an estimate of the gas required to execute a transaction, without submitting it. On Harmony the estimate covers L2 execution gas; the L1 data fee is separate.
...
--data-raw '{
    ...
    "params": [{ "from": "0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045", "to": "0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a", "value": "0xde0b6b3a7640000" }],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const gas = await provider.estimateGas({ from: '0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045', to: '0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a', value: ethers.parseEther('1') });
```
{% endcode %}
{% endtab %}
...
const gas = await client.estimateGas({ account: '0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045', to: '0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a', value: parseEther('1') });
```
{% endcode %}
{% endtab %}
{% endtabs %}
