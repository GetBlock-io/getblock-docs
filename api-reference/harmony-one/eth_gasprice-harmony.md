...
# eth\_gasPrice - Harmony

This method returns the current legacy gas price in wei, as a hex-encoded integer. On Harmony it reflects the L2 execution gas price and is used for legacy (non-EIP-1559) transactions.
