...
--data-raw '{
    "jsonrpc": "2.0",
    "method": "eth_getCode",
    "params": ["0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a", "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const code = await provider.getCode('0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a');
```
{% endcode %}
{% endtab %}
...
const code = await client.getCode({ address: '0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a' });
```
{% endcode %}
{% endtab %}
{% endtabs %}
