...
--data-raw '{
    "jsonrpc": "2.0",
    "method": "eth_getLogs",
    "params": [{ "fromBlock": "0x3d09000", "toBlock": "0x3d09100", "address": "0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a", "topics": ["0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef"] }],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const logs = await provider.getLogs({ address: '0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a', topics: ['0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef'], fromBlock: 64000000 });
```
{% endcode %}
{% endtab %}
...
const logs = await client.getLogs({ address: '0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a', fromBlock: 64000000n });
```
{% endcode %}
{% endtab %}
{% endtabs %}
