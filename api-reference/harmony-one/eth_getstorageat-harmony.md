...
--data-raw '{
    ...
    "params": ["0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a", "0x0", "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const value = await provider.getStorage('0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a', 0);
```
{% endcode %}
{% endtab %}
...
const value = await client.getStorageAt({ address: '0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a', slot: '0x0' });
```
{% endcode %}
{% endtab %}
{% endtabs %}
