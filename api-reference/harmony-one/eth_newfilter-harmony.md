...
--data-raw '{
    ...
    "params": [{ "fromBlock": "0x3d09000", "toBlock": "latest", "address": "0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a", "topics": ["0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef"] }],
    "id": "getblock.io"
}'
```
{% endcode %}
...
provider.on({ address: '0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a', topics: ['0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef'] }, (log) => console.log(log));
```
{% endcode %}
{% endtab %}
...
const filter = await client.createEventFilter({ address: '0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a' });
```
{% endcode %}
{% endtab %}
{% endtabs %}
