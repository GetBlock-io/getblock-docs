...
# net\_version - Harmony

This method returns the network ID as a decimal string. On Harmony the network ID matches the chain ID (1666600000) and is used to confirm which network an endpoint is connected to.
...
| result    | string | Network ID as a decimal string (1666600000 for Harmony) |

## Use Cases

* **Network Confirmation**: Verify a wallet or dApp is pointed at Harmony and not another chain
