---
description: >-
  Example code for the hmy_getBlockByHash json-rpc method. Сomplete guide on how
  to use hmy_getBlockByHash json-rpc in GetBlock.io Web3 documentation.
---

# hmy\_getBlockByHash - Harmony
