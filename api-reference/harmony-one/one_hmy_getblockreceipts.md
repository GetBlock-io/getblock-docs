---
description: >-
  Example code for the hmy_getBlockReceipts json-rpc method. Сomplete guide on
  how to use hmy_getBlockReceipts json-rpc in GetBlock.io Web3 documentation.
---

# hmy\_getBlockReceipts - Harmony
