---
description: >-
  Example code for the hmy_getTransactionReceipt json-rpc method. Сomplete guide
  on how to use hmy_getTransactionReceipt json-rpc in GetBlock.io Web3
  documentation.
---

# hmy\_getTransactionReceipt - Harmony
