---
description: >-
  Example code for the hmy_sendTransaction  {disallowed} json-rpc method.
  Сomplete guide on how to use hmy_sendTransaction  {disallowed} json-rpc in
  GetBlock.io Web3 documentation.
---

# hmy\_sendTransaction {disallowed} - Harmony
