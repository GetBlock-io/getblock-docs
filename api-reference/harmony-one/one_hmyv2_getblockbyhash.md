---
description: >-
  Example code for the hmyv2_getBlockByHash json-rpc method. Сomplete guide on
  how to use hmyv2_getBlockByHash json-rpc in GetBlock.io Web3 documentation.
---

# hmyv2\_getBlockByHash - Harmony
