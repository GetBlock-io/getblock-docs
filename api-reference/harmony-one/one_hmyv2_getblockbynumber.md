---
description: >-
  Example code for the hmyv2_getBlockByNumber json-rpc method. Сomplete guide on
  how to use hmyv2_getBlockByNumber json-rpc in GetBlock.io Web3 documentation.
---

# hmyv2\_getBlockByNumber - Harmony
...
Optional args struct in json format (can be used just with { }). Has "fullTx" to show full tx or not, "withSigners" to include block signes in blocks or not, "inclStaking" to show staking txs or not.
