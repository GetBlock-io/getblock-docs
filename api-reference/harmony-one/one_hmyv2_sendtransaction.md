---
description: >-
  Example code for the hmyv2_sendTransaction  {disallowed} json-rpc method.
  Сomplete guide on how to use hmyv2_sendTransaction  {disallowed} json-rpc in
  GetBlock.io Web3 documentation.
---

# hmyv2\_sendTransaction {disallowed} - Harmony
