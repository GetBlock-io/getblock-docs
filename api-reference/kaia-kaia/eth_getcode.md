...
const code = await provider.getCode('0x19aac5f612f524b754ca7e7c41cbfa2e981a4432');
console.log(code);
```
{% endcode %}
{% endtab %}
...
const code = await client.getBytecode({ address: '0x19aac5f612f524b754ca7e7c41cbfa2e981a4432' });
console.log(code);
```
{% endcode %}
{% endtab %}
