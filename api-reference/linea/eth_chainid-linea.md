...
This method returns the chain ID of the Linea network, used to sign replay-protected transactions under EIP-155. Linea Mainnet returns 0xe708 (59144).
...
| result    | string | Hex-encoded chain ID (0xe708 = 59144 for Linea Mainnet) |

## Use Cases

* **Replay Protection**: Include the chain ID when signing EIP-155 transactions
* **Network Detection**: Confirm a wallet is connected to Linea mainnet
