...
--data-raw '{
    ...
    "params": [{"from": "0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045", "to": "0xe5D7C2a44FfDDf6b295A15c148167daaAf5Cf34f", "value": "0xde0b6b3a7640000"}],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const gas = await provider.estimateGas({
    from: '0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045', to: '0xe5D7C2a44FfDDf6b295A15c148167daaAf5Cf34f', value: ethers.parseEther('1.0')
});
console.log(gas);
```
{% endcode %}
...
const gas = await client.estimateGas({
    account: '0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045', to: '0xe5D7C2a44FfDDf6b295A15c148167daaAf5Cf34f', value: 1000000000000000000n
});
console.log(gas);
```
{% endcode %}
