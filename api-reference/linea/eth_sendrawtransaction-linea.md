...
# eth\_sendRawTransaction - Linea

This method submits a signed, serialized transaction to the Linea network. On acceptance it returns the transaction hash; the transaction is then propagated to validators for inclusion.
