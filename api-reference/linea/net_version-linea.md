...
This method returns the current network ID as a string. For Linea mainnet the network ID is 59144.
...
| result    | string | Network ID as a decimal string (59144 for Linea Mainnet) |
...
* **Endpoint Validation**: Verify an RPC endpoint serves Linea
