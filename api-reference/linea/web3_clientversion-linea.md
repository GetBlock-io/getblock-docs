...
# web3\_clientVersion - Linea

This method returns the version string of the Linea client software the node is running. It identifies the node implementation and release.
...
```json
{
    "jsonrpc": "2.0",
    "id": "getblock.io",
    "result": "linea-besu/v24.9.1/linux-x86_64/openjdk-java-21"
}
```
