...
| --------- | ------ | ------------------------------------------------- |
| mode      | string | Optional. Mode: stats, mallocinfo. Default=stats. |
...
| free   | number | Number of bytes available. |
| total  | number | Total memory managed.      |
| locked | number | Amount of locked memory.   |
