...
# api/v2/tickers - Litecoin

This endpoint returns current or historical fiat exchange rates for Litecoin. A timestamp or block selects historical rates; without either, the latest available rates are returned.
...
* **Fiat Display**: Show an LTC amount in a user's local currency
* **Historical Valuation**: Value a past transaction at the rate of its block
* **Invoicing**: Convert a fiat-priced invoice into LTC at the current rate

## Error Handling

| HTTP Status | Message | Description |
| --- | --- | --- |
| 400 | Bad request | A query parameter is malformed |
