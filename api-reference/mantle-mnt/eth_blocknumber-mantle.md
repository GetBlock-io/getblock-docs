...
# eth\_blockNumber - Mantle

This method returns the number of the most recent block on the Mantle network.
...
* DeFi applications monitoring Mantle state
...
| 500         | Internal Server Error | Node synchronization issues     |
