...
This method returns the chain ID of the Mantle network. Mantle Mainnet uses chain ID 5000 (0x1388).
...
| result  | string | Chain ID in hexadecimal (0x1388 = 5000 for Mantle Mainnet) |
...
* Transaction signing with correct chain ID
