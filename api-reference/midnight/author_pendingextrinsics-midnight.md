...
# author\_pendingExtrinsics - Midnight
...
| ------ | --------------- | -------------------------------------------------------- |
| result | array of string | Array of hex-encoded SCALE-serialized pending extrinsics |
...
| -32053      | Not allowed       | the API Key is not allowed to access method                   |
...
// const raw = await (api as any)._rpcCore.provider.send('author_pendingExtrinsics', []);
```
{% endtab %}
