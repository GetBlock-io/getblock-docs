---
description: >-
  Example code for the childstate_getKeysPaged JSON-RPC method. Complete guide
  on how to use childstate_getKeysPaged JSON-RPC in GetBlock Web3 documentation.
---

# childstate\_getKeysPaged - Midnight

This method returns paged storage keys within a child trie. Use the `startKey` parameter to continue from a previous page.
...
| ------ | --------------- | ---------------------------------------------------- |
| result | array of string | Array of hex-encoded child trie keys (up to `count`) |

## Use Cases

* Efficient enumeration of large child tries
* Snapshot generation for contract state
* Memory-bounded indexing pipelines
...
// const raw = await (api as any)._rpcCore.provider.send('childstate_getKeysPaged', ["0x3a6368696c645f73746f726167653a64656661756c743a", "0x", 100]);
```
{% endtab %}
...
# Generic RPC call:
result = substrate.rpc_request('childstate_getKeysPaged', ["0x3a6368696c645f73746f726167653a64656661756c743a", "0x", 100])
print(result)
```
{% endtab %}
{% endtabs %}
