...
# childstate\_getStorageHash - Midnight

This method returns the hash of a value at a given key within a child trie. Useful for cheap change-detection.
...
| ------ | -------------- | ------------------------------------- |
| result | string \| null | Hash of the value, or `null` if unset |

## Use Cases

* Bandwidth-efficient change detection on contract storage
...
const result = await api.rpc.childstate.getStorageHash("0x3a6368696c645f73746f726167653a64656661756c743a", "0x80");
console.log(result.toJSON());

// Or call the raw JSON-RPC method:
const raw = await api.rpc.rpc.methods();
// const raw = await (api as any)._rpcCore.provider.send('childstate_getStorageHash', ["0x3a6368696c645f73746f726167653a64656661756c743a", "0x80"]);
```
{% endtab %}
...
# Generic RPC call:
result = substrate.rpc_request('childstate_getStorageHash', ["0x3a6368696c645f73746f726167653a64656661756c743a", "0x80"])
print(result)
```
{% endtab %}
{% endtabs %}
