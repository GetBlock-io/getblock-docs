...
| ------ | -------------- | -------------------------------------------------------- |
| result | string \| null | Hex-encoded storage value, or `null` if the key is unset |
...
// const raw = await (api as any)._rpcCore.provider.send('state_getStorage', ["0x26aa394eea5630e07c48ae0c9558cef7b99d880ec681799c0cf30e8886371da9"]);
```
{% endtab %}
