...
# system\_accountNextIndex - Midnight
...
// const raw = await (api as any)._rpcCore.provider.send('system_accountNextIndex', ["5GrwvaEF5zXb26Fz9rcQpDWS57CtERHpNehXCPcNoHGKutQY"]);
```
{% endtab %}
