...
# eth\_maxPriorityFeePerGas - Monad

This method returns the current suggested priority fee per gas for EIP-1559 transactions.
...
| ------ | ------ | --------------------------------------------------------------------- |
| result | string | Suggested priority fee per gas in MON-wei (hex). 0x77359400 = 2 Gwei. |
...
* Wallet gas settings
* Automated trading fee calculation
...
// Get fee data (includes maxPriorityFeePerGas)
