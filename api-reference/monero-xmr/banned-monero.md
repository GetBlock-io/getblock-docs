...
| --------- | ------ | -------- | ------------------------------- |
| address   | string | Yes      | IP address or hostname to check |
...
| -------------- | ------------ | ------------------------------------------------ |
| result.banned  | boolean      | `true` if the address is currently banned        |
| result.seconds | unsigned int | Seconds remaining on the ban (`0` if not banned) |
| result.status  | string       | `OK` if the query succeeded                      |
