...
* An EVM wallet (such as MetaMask) with GLMR on Moonbeam for gas — see [Add Network to Your Wallet](deploy-a-smart-contract-on-moonbeam.md#add-network-to-your-wallet) and [Funding Your Deployer](deploy-a-smart-contract-on-moonbeam.md#funding-your-deployer)
...
Enter the values from the [Network Details](deploy-a-smart-contract-on-moonbeam.md#network-details) table above.
{% endstep %}
