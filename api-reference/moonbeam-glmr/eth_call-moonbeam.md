...
--data-raw '{
    "jsonrpc": "2.0",
    "method": "eth_call",
    "params": [{ "to": "0xAcc15dC74880C9944775448304B263D191c6077F", "data": "0x70a08231000000000000000000000000d8da6bf26964af9d7eed9e03e53415d37aa96045" }, "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const result = await provider.call({ to: '0xAcc15dC74880C9944775448304B263D191c6077F', data: '0x70a08231000000000000000000000000d8da6bf26964af9d7eed9e03e53415d37aa96045' });
```
{% endcode %}
{% endtab %}
...
const balance = await client.readContract({ address: '0xAcc15dC74880C9944775448304B263D191c6077F', abi: erc20Abi, functionName: 'balanceOf', args: ['0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045'] });
```
{% endcode %}
{% endtab %}
{% endtabs %}
