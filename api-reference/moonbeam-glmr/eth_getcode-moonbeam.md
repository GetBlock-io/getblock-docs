...
--data-raw '{
    "jsonrpc": "2.0",
    "method": "eth_getCode",
    "params": ["0xAcc15dC74880C9944775448304B263D191c6077F", "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const code = await provider.getCode('0xAcc15dC74880C9944775448304B263D191c6077F');
```
{% endcode %}
{% endtab %}
...
const code = await client.getCode({ address: '0xAcc15dC74880C9944775448304B263D191c6077F' });
```
{% endcode %}
{% endtab %}
{% endtabs %}
