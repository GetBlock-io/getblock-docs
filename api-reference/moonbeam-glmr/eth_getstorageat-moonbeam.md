...
--data-raw '{
    ...
    "params": ["0xAcc15dC74880C9944775448304B263D191c6077F", "0x0", "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const value = await provider.getStorage('0xAcc15dC74880C9944775448304B263D191c6077F', 0);
```
{% endcode %}
{% endtab %}
...
const value = await client.getStorageAt({ address: '0xAcc15dC74880C9944775448304B263D191c6077F', slot: '0x0' });
```
{% endcode %}
{% endtab %}
{% endtabs %}
