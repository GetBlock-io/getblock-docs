# net\_version - Moonbeam

This method returns the network ID as a decimal string. On Moonbeam the network ID matches the chain ID (1284) and is used to confirm which network an endpoint is connected to.
...
| result    | string | Network ID as a decimal string (1284 for Moonbeam) |

## Use Cases

* **Network Confirmation**: Verify a wallet or dApp is pointed at Moonbeam and not another chain
