---
description: >-
  Example code for the chain_getBlock json-rpc method. Сomplete guide on how to
  use chain_getBlock json-rpc in GetBlock.io Web3 documentation.
---

# chain\_getBlock - Moonriver
