---
description: >-
  Example code for the chain_getHeader json-rpc method. Сomplete guide on how to
  use chain_getHeader json-rpc in GetBlock.io Web3 documentation.
---

# chain\_getHeader - Moonriver
