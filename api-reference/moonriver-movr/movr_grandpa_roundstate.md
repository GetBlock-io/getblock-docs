---
description: >-
  Example code for the grandpa_roundState json-rpc method. Сomplete guide on how
  to use grandpa_roundState json-rpc in GetBlock.io Web3 documentation.
---

# grandpa\_roundState - Moonriver
