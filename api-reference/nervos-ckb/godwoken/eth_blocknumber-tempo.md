# eth\_blocknumber tempo

Returns the number of the most recent block on Tempo. With \~0.6 second block times and deterministic finality, this is the standard way to poll for the chain tip.
...
* Polling for new blocks in indexers and dApps
...
const result = await client.request({ method: 'eth_blockNumber', params: [] });
console.log(result);
```
{% endtab %}
{% endtabs %}
