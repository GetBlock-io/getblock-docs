# eth\_getblockreceipts tempo

Returns all transaction receipts for a Tempo block. More efficient than calling `eth_getTransactionReceipt` per transaction.
    ...
    "result": [
        {
            ...
            "gasUsed": "0x12345",
            "logs": [],
            "logsBloom": "",
            "status": "0x1",
...
| result\[].type    | string | Transaction type: `0x0` legacy, `0x2` EIP-1559, `0x54` Tempo Transaction |

## Use Cases

* Indexing payment activity across all transactions in a block
* Building gas-cost analytics per block
* Detecting reverted payment attempts
