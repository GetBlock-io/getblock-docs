...
Returns transaction details by transaction hash. Standard EVM transactions return the usual fields; Tempo Transactions (type `0x54`) include additional Tempo-specific fields like memo and fee-payer data.
...
| result.to        | string \| null | Recipient address; `null` for contract creations. For TIP-20 transfers, this is the token contract address   |
