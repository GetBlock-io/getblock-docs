# eth\_gettransactioncount tempo
...
const result = await provider.send('eth_getTransactionCount', ["0xd85498dbeaeb1df24be52eed4f52eac2fbd56245", "latest"]);
console.log(result);
```
{% endtab %}
...
const result = await client.request({ method: 'eth_getTransactionCount', params: ["0xd85498dbeaeb1df24be52eed4f52eac2fbd56245", "latest"] });
console.log(result);
```
{% endtab %}
{% endtabs %}
