...
Returns the current network ID as a decimal string. For Tempo mainnet: `"4217"`; for Moderato testnet: `"42431"`. Decimal string format, unlike `eth_chainId` which returns hex.
...
| ------ | ------ | --------------------------------------------------------- |
| result | string | Network ID as a decimal string (`4217` for Tempo mainnet) |
