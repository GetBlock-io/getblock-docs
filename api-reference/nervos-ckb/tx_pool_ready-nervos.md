---
description: >-
  Example code for the tx_pool_ready JSON-RPC method. Complete guide on how to
  use tx_pool_ready JSON-RPC in GetBlock Web3 documentation.
---

# tx\_pool\_ready - Nervos
...
| ------ | ------- | ----------------------- |
| result | boolean | `true` if pool is ready |
...
const result = await rpc.send('tx_pool_ready', []);
console.log(result);
```
{% endtab %}
