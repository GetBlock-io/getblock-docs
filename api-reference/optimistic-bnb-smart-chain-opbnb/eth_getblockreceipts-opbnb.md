...
description: >-
  ...
  how to use eth_getBlockReceipts JSON-RPC in GetBlock.io Web3 documentation.
---

# eth\_getBlockReceipts - opBNB

This method returns all transaction receipts for the transactions in a given block. It is significantly more efficient than calling `eth_getTransactionReceipt` for each transaction individually.
