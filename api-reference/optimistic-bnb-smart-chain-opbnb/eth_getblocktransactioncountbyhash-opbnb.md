...
# eth\_getBlockTransactionCountByHash - opBNB
...
const result = await client.request({ method: 'eth_getBlockTransactionCountByHash', params: ["0x4f3a1d6e8c2b9a7e5d3f1c8a4b6e9d2f5a8c3e7b1d4f9a6c2e5b8d3f7a1c4e9b"] });
console.log(result);
```
{% endcode %}
{% endtab %}
