...
const result = await provider.send('eth_getStorageAt', ["0x9e7c5e3e3a3b8e1aa0e2d4c7f9d4b0c8b8d5f1a2", "0x0", "latest"]);
console.log(result);
```
{% endcode %}
{% endtab %}
...
const result = await client.request({ method: 'eth_getStorageAt', params: ["0x9e7c5e3e3a3b8e1aa0e2d4c7f9d4b0c8b8d5f1a2", "0x0", "latest"] });
console.log(result);
```
{% endcode %}
{% endtab %}
