...
# eth\_getTransactionByBlockHashAndIndex - opBNB

This method returns transaction details by block hash and the transaction's index within that block.
...
| ------ | -------------- | -------------------------------------------------------------------------------------- |
| result | object \| null | Transaction object (same schema as `eth_getTransactionByHash`), or `null` if not found |

## Use Cases

* Iterating transactions within a known block
* Indexers that walk blocks transaction by transaction
* Replaying block contents in test environments
...
const result = await provider.send('eth_getTransactionByBlockHashAndIndex', ["0x4f3a1d6e8c2b9a7e5d3f1c8a4b6e9d2f5a8c3e7b1d4f9a6c2e5b8d3f7a1c4e9b", "0x0"]);
console.log(result);
```
{% endcode %}
{% endtab %}
...
const result = await client.request({ method: 'eth_getTransactionByBlockHashAndIndex', params: ["0x4f3a1d6e8c2b9a7e5d3f1c8a4b6e9d2f5a8c3e7b1d4f9a6c2e5b8d3f7a1c4e9b", "0x0"] });
console.log(result);
```
{% endcode %}
{% endtab %}
