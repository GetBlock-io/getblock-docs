...
# eth\_maxPriorityFeePerGas - opBNB

This method returns the suggested priority fee per gas (the "tip" portion of EIP-1559 transactions). Use this together with the block's base fee to construct a competitive EIP-1559 transaction.
...
* Server-side fee oracles that price urgency
