...
# net\_peerCount - opBNB

This method returns the number of peers currently connected to the node, as a hex string. Managed RPC endpoints may report a representative count rather than a live peer set.
