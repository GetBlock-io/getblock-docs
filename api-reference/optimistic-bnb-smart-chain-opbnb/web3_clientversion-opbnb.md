...
# web3\_clientVersion - opBNB

This method returns the version string of the client software running the node. For opBNB this is typically an op-geth fork; the exact string depends on the build.
...
```json
{
    "jsonrpc": "2.0",
    "id": "getblock.io",
    "result": "opbnb/v0.5.1-stable/linux-amd64/go1.21.5"
}
```
{% endcode %}
