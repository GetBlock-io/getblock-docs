---
description: >-
  Example code for the beefy_getFinalizedHead JSON RPC method. Complete guide on
  how to use beefy_getFinalizedHead JSON RPC in GetBlock Web3 documentation.
---

# beefy\_getFinalizedHead - Polkadot
