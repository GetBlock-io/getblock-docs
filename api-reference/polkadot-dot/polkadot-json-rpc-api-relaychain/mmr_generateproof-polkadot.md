---
description: >-
  Example code for the mmr_generateProof JSON RPC method. Complete guide on how
  to use mmr_generateProof JSON RPC in GetBlock Web3 documentation.
---

# mmr\_generateProof - Polkadot
