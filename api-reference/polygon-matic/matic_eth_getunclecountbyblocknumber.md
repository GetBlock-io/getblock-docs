...
The **eth\_getUncleCountByBlockNumber** method returns the number of uncles in a block matching the given block number.
...
The eth\_getUncleCountByBlockNumber method is useful for:
