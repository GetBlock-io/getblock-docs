...
The `net_version` method returns the current network ID as a string. For Polygon mainnet, this returns `"137"`.
...
| result  | varies | Network ID as string   |

## Use Case

The `net_version` method is useful for:
