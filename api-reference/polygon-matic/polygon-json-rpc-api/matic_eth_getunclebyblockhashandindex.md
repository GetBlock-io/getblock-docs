...
The **eth\_getUncleByBlockNumberAndIndex** method returns information about an uncle of a block by number and uncle index position.
...
The eth\_getUncleByBlockNumberAndIndex method is useful for:
...
const result = await provider.send('eth_getUncleByBlockNumberAndIndex', ["0x3A2B5C7", "0x0"]);
