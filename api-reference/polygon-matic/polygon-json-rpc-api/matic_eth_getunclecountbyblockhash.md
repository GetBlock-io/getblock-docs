...
The **eth\_getUncleCountByBlockHash** method returns the number of uncles in a block matching the given block hash.
...
| result  | varies | Number of uncles as hexadecimal |

## Use Case

The eth\_getUncleCountByBlockHash method is useful for:
...
const result = await provider.send('eth_getUncleCountByBlockHash', ["0x3f07a9c83155594c000642e7d60e8a8a00038d03e9849171a05ed0e2d47acbb3"]);
