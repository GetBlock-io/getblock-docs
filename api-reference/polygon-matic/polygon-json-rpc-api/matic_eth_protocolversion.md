...
The `eth_protocolVersion` method returns the current Ethereum protocol version used by the node.
...
| result  | varies | Protocol version as hexadecimal |

## Use Case

The `eth_protocolVersion` method is useful for:
