...
The `eth_syncing` method returns an object with data about the sync status or `false` if the node is fully synced.
...
| result  | varies | False if synced, or object with startingBlock, currentBlock, highestBlock |
