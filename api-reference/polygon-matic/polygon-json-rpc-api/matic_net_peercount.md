...
The **net\_peerCount** method returns the number of peers currently connected to the client.
...
| result  | varies | Number of connected peers as hexadecimal |

## Use Case

The net\_peerCount method is useful for:
