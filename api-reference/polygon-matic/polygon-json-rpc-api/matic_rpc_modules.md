...
The **rpc\_modules** method returns the list of RPC modules enabled on the node along with their versions.
...
| result  | varies | Object with module names and versions |

## Use Case

The rpc\_modules method is useful for:
