---
description: >-
  Learn how to use web3_clientVersion JSON-RPC method to retrieve the Polygon
  client version. Complete guide with examples for identifying node software and
  version info.
---
...
| result  | varies | Client version string  |
