...
description: >-
  ...
  to using the debug_traceblockbynumber JSON-RPC method in the GetBlock.io Web3
  documentation.
---

# debug\_traceblockbynumber - Ronin
...
* **Block Analysis**: Trace all execution in a block by number
* **Internal Transfers**: Extract internal value transfers across a block
* **Indexing**: Build an internal-call index from full block traces
