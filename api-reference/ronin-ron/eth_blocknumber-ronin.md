...
description: >-
  ...
  the eth_blockNumber JSON-RPC method in the GetBlock.io Web3 documentation.
---

# eth\_blockNumber - Ronin

This method returns the number of the most recent block on Ronin. It is the primary method for reading the current chain height.
