...
description: >-
  ...
  the eth_getBalance JSON-RPC method in the GetBlock.io Web3 documentation.
---

# eth\_getBalance - Ronin

This method returns the native RON balance of an address at a given block, in wei. It is the primary method for reading an account's spendable balance.
...
* **Wallet Balances**: Display an account's native RON balance
