...
description: >-
  ...
  eth_getCode JSON-RPC method in the GetBlock.io Web3 documentation.
---
...
--data-raw '{
    "jsonrpc": "2.0",
    "method": "eth_getCode",
    "params": ["0xe514d9deb7966c8be0ca922de8a064264ea6bcd4", "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const code = await provider.getCode('0xe514d9deb7966c8be0ca922de8a064264ea6bcd4');
console.log(code);
```
{% endcode %}
{% endtab %}
...
const code = await client.getBytecode({ address: '0xe514d9deb7966c8be0ca922de8a064264ea6bcd4' });
console.log(code);
```
{% endcode %}
{% endtab %}
