...
--data-raw '{
    ...
    "params": ["0xe514d9deb7966c8be0ca922de8a064264ea6bcd4", "0x0", "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const value = await provider.getStorage('0xe514d9deb7966c8be0ca922de8a064264ea6bcd4', 0);
console.log(value);
```
{% endcode %}
{% endtab %}
...
const value = await client.getStorageAt({ address: '0xe514d9deb7966c8be0ca922de8a064264ea6bcd4', slot: '0x0' });
console.log(value);
```
{% endcode %}
{% endtab %}
