...
description: >-
  ...
  using the eth_sendRawTransaction JSON-RPC method in the GetBlock.io Web3
  documentation.
---

# eth\_sendRawTransaction - Ronin

This method submits a signed, serialized transaction to the Ronin network. On acceptance it returns the transaction hash; the transaction is then propagated to validators for inclusion.
...
* **Payment Broadcast**: Submit a signed native RON transfer
