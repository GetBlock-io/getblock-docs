...
description: >-
  ...
  using the web3_clientVersion JSON-RPC method in the GetBlock.io Web3
  documentation.
---

# web3\_clientVersion - Ronin

This method returns the version string of the Ronin client software the node is running. It identifies the node implementation and release.
...
```json
{
    "jsonrpc": "2.0",
    "id": "getblock.io",
    "result": "Ronin/v2.8.0/linux-amd64/go1.22"
}
```
