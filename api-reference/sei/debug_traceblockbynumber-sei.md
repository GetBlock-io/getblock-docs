...
description: >-
  ...
  on how to use debug_traceBlockByNumber JSON-RPC in GetBlock Web3 documentation
---

# debug\_traceBlockByNumber - SEI

Traces all transactions in a block on the Sei network by block number, returning detailed execution information.
...
const result = await provider.send('debug_traceBlockByNumber', ["latest", {"tracer": "callTracer"}]);
console.log(result);
```
{% endcode %}
{% endtab %}
