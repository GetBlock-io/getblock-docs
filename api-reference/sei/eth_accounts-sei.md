...
description: >-
  ...
  use eth_newBlockFilter JSON-RPC in GetBlock Web3 documentation
---

# eth\_accounts - SEI

Returns a list of addresses owned by the client. Since GetBlock does not store private keys, this method returns an empty array. It is included for compatibility with the Ethereum JSON-RPC specification.
...
| ------ | ----- | ---------------------------------------------------- |
| result | array | An empty array, as GetBlock does not manage accounts |

## Use Case

The `eth_accounts` method is essential for:
