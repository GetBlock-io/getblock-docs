...
| ----------- | ------ | ---------------------------------------------------------------------------------------- |
| transaction | object | The transaction call object with 'from', 'to', 'gas', 'gasPrice', 'value', 'data' fields |
...
| ------ | ------ | ---------------------------------------------- |
| result | string | The return value of the executed contract call |
...
const result = await provider.send('eth_call', [{"to": "0x1234567890abcdef1234567890abcdef12345678", "data": "0x70a08231000000000000000000000000742d35cc6634c0532925a3b844bc9e7595f5be21"}, "latest"]);
console.log(result);
```
{% endtab %}
