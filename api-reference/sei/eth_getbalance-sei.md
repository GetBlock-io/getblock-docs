...
Returns the balance of the account at the specified address on the Sei network. The balance is returned in wei (the smallest unit of SEI, where 1 SEI = 10^18 wei).
