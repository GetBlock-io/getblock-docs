...
# eth\_getBlockByHash- SEI

This method returns information about a block on the Sei network by its hash. Can include full transaction objects or just transaction hashes.
...
const result = await provider.send('eth_getBlockByHash', ["0x9a5e2b3c...", true]);
console.log(result);
```
{% endtab %}
