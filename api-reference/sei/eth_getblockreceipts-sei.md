...
# eth\_getBlockReceipts - SEI

Returns all transaction receipts for a given block on the Sei network. Useful for analyzing all transactions in a block at once.
