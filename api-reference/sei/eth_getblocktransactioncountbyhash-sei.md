...
# eth\_getBlockTransactionCountByHash - SEI

Returns the number of transactions in a block specified by block hash on the Sei network.
...
--data '{
    ...
    "params": ["0x9a5e2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
| ------ | ------ | ------------------------------------------------------- |
| result | string | The number of transactions in the block as a hex string |
...
const result = await provider.send('eth_getBlockTransactionCountByHash', ["0x9a5e2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a"]);
console.log(result);
```
{% endcode %}
{% endtab %}
