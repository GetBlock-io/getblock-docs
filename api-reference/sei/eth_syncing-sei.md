...
Returns the sync status of the Sei node. Returns `false` if the node is fully synced, or an object with sync progress if syncing.
...
| ------ | -------------- | ----------------------------------------------------- |
| result | boolean/object | False if not syncing, or an object with sync progress |
