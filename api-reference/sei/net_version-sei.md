...
Returns the network ID of the Sei network as a decimal string. This is an alias for eth\_chainId but returns the value as decimal instead of hex.
...
| ------ | ------ | ---------------------------------- |
| result | string | The network ID as a decimal string |
