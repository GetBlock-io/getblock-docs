...
# eth\_getBalance - Sonic

This method returns the native S balance of an address at a given block, in wei. It is the primary method for reading an account's spendable balance.
...
* **Wallet Balances**: Display an account's native S balance
