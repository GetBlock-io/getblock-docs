...
This method returns the chain ID of the Sonic network, used to sign replay-protected transactions under EIP-155. Sonic mainnet returns `0x92` (146).
...
| result    | string | Hex-encoded chain ID (0x92 = 146 for Sonic mainnet) |

## Use Cases

* **Replay Protection**: Include the chain ID when signing EIP-155 transactions
* **Network Detection**: Confirm a wallet is connected to Sonic mainnet
