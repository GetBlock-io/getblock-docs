...
const code = await provider.getCode('0x039e2fB66102314Ce7b64Ce5Ce3E5183bc94aD38');
console.log(code);
```
{% endcode %}
{% endtab %}
...
const code = await client.getBytecode({ address: '0x039e2fB66102314Ce7b64Ce5Ce3E5183bc94aD38' });
console.log(code);
```
{% endcode %}
{% endtab %}
