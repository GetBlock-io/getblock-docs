...
--data-raw '{
    ...
    "params": ["0x039e2fB66102314Ce7b64Ce5Ce3E5183bc94aD38", "0x0", "latest"],
    "id": "getblock.io"
}'
```
{% endcode %}
...
const value = await provider.getStorage('0x039e2fB66102314Ce7b64Ce5Ce3E5183bc94aD38', 0);
console.log(value);
```
{% endcode %}
{% endtab %}
...
const value = await client.getStorageAt({ address: '0x039e2fB66102314Ce7b64Ce5Ce3E5183bc94aD38', slot: '0x0' });
console.log(value);
```
{% endcode %}
{% endtab %}
