...
# eth\_sendRawTransaction - Sonic

This method submits a signed, serialized transaction to the Sonic network. On acceptance it returns the transaction hash; the transaction is then propagated to validators for inclusion.
...
* **Payment Broadcast**: Submit a signed native S transfer
