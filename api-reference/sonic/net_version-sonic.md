...
This method returns the current network ID as a string. For Sonic mainnet the network ID is 146.
...
| result    | string | Network ID as a decimal string (146 for Sonic mainnet) |
...
* **Endpoint Validation**: Verify an RPC endpoint serves Sonic
