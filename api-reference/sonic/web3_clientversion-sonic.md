...
# web3\_clientVersion - Sonic

This method returns the version string of the Sonic client software the node is running. It identifies the node implementation and release.
...
```json
{
    "jsonrpc": "2.0",
    "id": "getblock.io",
    "result": "Sonic/v2.0.4/linux-amd64/go1.22"
}
```
