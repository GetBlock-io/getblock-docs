...
# suix\_getDynamicFieldObject{deprecated} - Sui

This method returns information about a specific dynamic field on the SUI network. While `suix_getDynamicFields` lists all dynamic fields. This method retrieves the full data for a single dynamic field given its name and type.
