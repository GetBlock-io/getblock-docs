...
# suix\_queryEvents{deprecated} - Sui

This method returns events that match the specified query criteria on the SUI network. Events are emitted by Move modules during transaction execution and provide powerful tracking of on-chain activities.
