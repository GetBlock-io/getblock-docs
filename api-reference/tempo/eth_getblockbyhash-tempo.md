...
const result = await provider.send('eth_getBlockByHash', ["0x6baa8fa86b9a7e5d3f1c8a4b6e9d2f5a8c3e7b1d4f9a6c2e5b8d3f7a1c4e9b2d", false]);
console.log(result);
```
{% endtab %}
...
const result = await client.request({ method: 'eth_getBlockByHash', params: ["0x6baa8fa86b9a7e5d3f1c8a4b6e9d2f5a8c3e7b1d4f9a6c2e5b8d3f7a1c4e9b2d", false] });
console.log(result);
```
{% endtab %}
{% endtabs %}
