...
# web3\_clientVersion - Tempo

Returns the version string of the client software running the node. Tempo nodes run a customized fork of Paradigm's Reth client.
