---
description: >-
  Example code for the getaddressstate JSON-RPC method. Сomplete guide on how to
  use getaddressstate JSON-RPC in GetBlock.io Web3 documentation.
---
...
| --------- | ------- | -------- | ---------------------------------------------------------------------- |
| address   | string  | Yes      | Address to query in any form                                           |
...
```bash
curl --location --request GET 'https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/getAddressState?address=EQDtFpEwcFAEcRe5mLVh2N6C0x-_hJEM7W61_JLnSF74p4q2' \
...
| result | string  | Account state: `active`, `uninitialized`, or `frozen` |
