...
```bash
curl --location --request GET 'https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/getBlockTransactions?workchain=-1&shard=-9223372036854775808&seqno=45792554' \
