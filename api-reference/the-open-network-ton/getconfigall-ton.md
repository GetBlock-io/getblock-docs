---
description: >-
  Example code for the getconfigall JSON-RPC method. Сomplete guide on how to
  use getconfigall JSON-RPC in GetBlock.io Web3 documentation.
---
...
```bash
curl --location --request GET 'https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/getConfigAll' \
...
| result.config.bytes | string | Base64-encoded BOC of the full configuration |
