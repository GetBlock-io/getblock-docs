...
```bash
curl --location --request GET 'https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/getLibraries?libraries=0E5F84CDDFCC0A3B23F18EDC6E70C45F40DDFCB6C8E97D43F8A1023AA873F2D7' \
