---
description: >-
  Example code for the getoutmsgqueuesize JSON-RPC method. Сomplete guide on how
  to use getoutmsgqueuesize JSON-RPC in GetBlock.io Web3 documentation.
---
...
```bash
curl --location --request GET 'https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/getOutMsgQueueSize' \
...
| ----------- | ------- | ---------------------------------------------------------- |
| result.size | integer | Number of messages currently in the outbound message queue |
