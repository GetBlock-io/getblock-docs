...
This method unpacks a user-friendly base64 address (`EQ…` / `UQ…`) into the raw `workchain:hex` form.

## Parameters

| Parameter | Type   | Required | Description                          |
| --------- | ------ | -------- | ------------------------------------ |
| address   | string | Yes      | Address in user-friendly base64 form |
...
```bash
curl --location --request GET 'https://shared.eu-central-1.getblock.io/<ACCESS-TOKEN>/unpackAddress?address=EQDtFpEwcFAEcRe5mLVh2N6C0x-_hJEM7W61_JLnSF74p4q2' \
...
{
    "ok": true,
    "result": "0:ed16913070500471175e992b561d8de82d31fbf84910ced6eb5fc92e74485ef8a",
    "id": "getblock.io",
    "jsonrpc": "2.0"
}
```
...
| ------ | ------ | ------------------------------------------------- |
| result | string | Raw `workchain:hex` representation of the address |

## Use Cases

* Converting user input to the raw form expected by some low-level APIs
* Storage normalisation in databases (raw form is canonical)
* Workchain extraction from user-friendly addresses
