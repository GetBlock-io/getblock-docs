---
description: >-
  The createtransaction method in Tron's HTTP REST API Interface enables
  seamless transaction creation with precision and efficiency.
---
...
1. **owner\_address**
   * Type: String
   * Description: Defaults to `TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g`. Owner\_address is the transfer address, converted to a hex string.
   * Example Value: `TZ4UXDV5ZhNW7fb2AMSbgfAEZ7hWsnYS2g`
2. **to\_address**
   * Type: String
   * Description: Defaults to `TPswDDCAWhJAZGdHPidFg5nEf8TkNToDX1`. To\_address is the transfer address, converted to a hex string.
