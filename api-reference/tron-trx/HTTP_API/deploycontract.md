---
description: >-
  Deploy smart contracts using the 'deploycontract' method via Tron’s HTTP REST
  API Interface.
---
...
9. **consume\_user\_resource\_percent** (`int32`)
...
10. **permission\_id** (`int32`) _(Optional)_
