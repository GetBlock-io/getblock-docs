---
description: >-
  Example code for the CreateTransaction2 gRPC method. Complete guide on how to
  use CreateTransaction2 gRPC method in GetBlock Web3 documentation.
---

# CreateTransaction2 - Tron
...
grpcurl -H 'x-api-key: <ACCESS-TOKEN>' \
  ...
  shared.eu-central-1.getblock.io:443 protocol.Wallet/CreateTransaction2
```
{% endcode %}
{% endtab %}
