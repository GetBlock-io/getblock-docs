---
description: >-
  Example code for the GetChainParameters gRPC method. Complete guide on how to
  use GetChainParameters gRPC method in GetBlock Web3 documentation.
---
...
grpcurl -H 'x-api-key: <ACCESS-TOKEN>' \
  -d '{}' \
  shared.eu-central-1.getblock.io:443 protocol.Wallet/GetChainParameters
```
{% endcode %}
{% endtab %}
