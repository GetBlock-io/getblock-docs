---
description: >-
  Example code for the GetNowBlock2 gRPC method. Complete guide on how to use
  GetNowBlock2 gRPC method in GetBlock Web3 documentation.
---
...
grpcurl -H 'x-api-key: <ACCESS-TOKEN>' \
  -d '{}' \
  shared.eu-central-1.getblock.io:443 protocol.Wallet/GetNowBlock2
```
{% endcode %}
{% endtab %}
