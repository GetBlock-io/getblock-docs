---
description: >-
  Example code for the GetTransactionInfoById gRPC method. Complete guide on how
  to use GetTransactionInfoById gRPC method in GetBlock Web3 documentation.
---
...
grpcurl -H 'x-api-key: <ACCESS-TOKEN>' \
  ...
  shared.eu-central-1.getblock.io:443 protocol.Wallet/GetTransactionInfoById
```
{% endcode %}
{% endtab %}
