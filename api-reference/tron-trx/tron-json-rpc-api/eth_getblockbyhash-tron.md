---
description: >-
  Example code for the eth_getBlockByHash JSON_RPC method. Complete guide on how
  to use eth_getBlockByHash JSON_RPC method in GetBlock Web3 documentation.
---

# eth\_getBlockByHash - Tron

This method returns information about a block by its hash. The second parameter selects full transaction objects or transaction hashes.
...
--data-raw '{
    ...
    "params": ["0x0000000002f3a5b0f6d2e6c9a1b4e7f0a3b6c9d2e5f8a1b4c7d0e3f6a9b2c5d8", false],
    "id": "getblock.io"
}'
```
{% endcode %}
...
* **Indexing**: Read a block found by hash
