---
description: >-
  Example code for the eth_getBlockTransactionCountByNumber JSON_RPC method.
  Complete guide on how to use eth_getBlockTransactionCountByNumber JSON_RPC
  method in GetBlock Web3 documentation.
---

# eth\_getBlockTransactionCountByNumber - Tron

This method returns the number of transactions in a block identified by its number, hex-encoded.
