...
# eth\_blockNumber - Unichain

This method returns the number of the most recent block on Unichain. It is the primary method for reading the current chain height.
