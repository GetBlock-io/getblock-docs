...
# eth\_chainId - Unichain

This method returns the chain ID of the Unichain network, used to sign replay-protected transactions under EIP-155. Unichain Mainnet returns 0x82 (130).
...
| result    | string | Hex-encoded chain ID (0x82 = 130 for Unichain Mainnet) |

## Use Cases

* **Replay Protection**: Include the chain ID when signing EIP-155 transactions
* **Network Detection**: Confirm a wallet is connected to Unichain mainnet
