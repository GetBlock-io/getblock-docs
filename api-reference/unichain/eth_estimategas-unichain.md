...
const gas = await provider.estimateGas({
    from: '0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045', to: '0x4200000000000000000000000000000000000006', value: ethers.parseEther('1.0')
});
console.log(gas);
```
{% endcode %}
...
const gas = await client.estimateGas({
    account: '0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045', to: '0x4200000000000000000000000000000000000006', value: 1000000000000000000n
});
console.log(gas);
```
{% endcode %}
