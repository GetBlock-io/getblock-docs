...
const code = await provider.getCode('0x4200000000000000000000000000000000000006');
console.log(code);
```
{% endcode %}
{% endtab %}
...
const code = await client.getBytecode({ address: '0x4200000000000000000000000000000000000006' });
console.log(code);
```
{% endcode %}
{% endtab %}
