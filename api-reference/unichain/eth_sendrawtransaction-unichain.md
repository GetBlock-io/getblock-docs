...
# eth\_sendRawTransaction - Unichain

This method submits a signed, serialized transaction to the Unichain network. On acceptance, it returns the transaction hash; the transaction is then propagated to validators for inclusion.
...
* **Payment Broadcast**: Submit a signed native ETH transfer
