...
# net\_version - Unichain

This method returns the current network ID as a string. For Unichain mainnet the network ID is 130.
...
| result    | string | Network ID as a decimal string (130 for Unichain Mainnet) |
...
* **Endpoint Validation**: Verify an RPC endpoint serves Unichain
