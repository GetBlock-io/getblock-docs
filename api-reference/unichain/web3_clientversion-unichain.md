...
# web3\_clientVersion - Unichain

This method returns the version string of the Unichain client software the node is running. It identifies the node implementation and release.
...
```json
{
    "jsonrpc": "2.0",
    "id": "getblock.io",
    "result": "op-geth/v1.101411.0/linux-amd64/go1.22"
}
```
