...
# eth\_getblocktransactioncountbynumber - Worldchain

Returns the number of transactions in a block specified by block number on the World Chain network.
...
The `eth_getBlockTransactionCountByNumber` method on World Chain is typically used for:
