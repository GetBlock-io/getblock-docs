...
# eth\_syncing - Worldchain

Returns an object with data about the sync status or false if not syncing on the World Chain network.
...
The `eth_syncing` method on World Chain is typically used for:
