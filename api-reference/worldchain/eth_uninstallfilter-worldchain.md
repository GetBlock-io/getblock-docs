...
# eth\_uninstallfilter - Worldchain
...
| --------- | ------ | ---------------------- |
| filterId  | string | Filter ID to uninstall |
...
| ------ | ------- | ------------------------------------------------------------ |
| result | boolean | True if filter was successfully uninstalled, false otherwise |
...
console.log('Uninstalled:', result);
```
{% endtab %}
...
const result = await client.uninstallFilter({ filter });
console.log('Uninstalled:', result);
```
{% endtab %}
{% endtabs %}
