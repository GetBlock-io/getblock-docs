...
# net\_peercount - Worldchain

Returns number of peers currently connected to the client on the World Chain network.
...
| ------ | ------ | ----------------------------------------------------------- |
| result | string | Hexadecimal representation of the number of connected peers |

### Use Case

The `net_peerCount` method on World Chain is typically used for:
