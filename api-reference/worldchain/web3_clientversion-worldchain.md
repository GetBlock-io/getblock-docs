...
# web3\_clientversion - Worldchain

Returns the current client version on the World Chain network.
...
| ------ | ------ | ----------------------------- |
| result | string | Current client version string |

### Use Case

The `web3_clientVersion` method on World Chain is typically used for:
