...
```json
{
    ...
    "result": {
        ...
        "gasUsed": "0x12345",
        "logs": [],
        "logsBloom": "",
        "status": "0x1",
...
| result.contractAddress   | string | `null` if this was a contract creation; deployed contract address |
...
* Determining the L1 batch that contained the transaction
...
const result = await provider.send('eth_getTransactionReceipt', ["0x22de7debaa98758afdaee89f447ff43bab5da3de6acca7528b281cc2f1be2ee9"]);
console.log(result);
```
{% endtab %}
...
result = zk_web3.zksync._zks_endpoints if 'eth_getTransactionReceipt'.startswith('zks_') else None
# Or call any method generically:
result = zk_web3.provider.make_request('eth_getTransactionReceipt', ["0x22de7debaa98758afdaee89f447ff43bab5da3de6acca7528b281cc2f1be2ee9"])
print(result)
```
{% endtab %}
{% endtabs %}
