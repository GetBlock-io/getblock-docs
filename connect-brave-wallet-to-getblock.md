...
GetBlock’s **private RPC nodes** can solve this problem. After downloading the Brave browser and setting up the wallet, visit [https://account.getblock.io/](https://account.getblock.io/) and get one of the 100+ available chain endpoints.
